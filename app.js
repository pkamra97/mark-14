    ...
    if(initial >0 && current >0 && quantity >0)
{
    ...
    {//loss report 
        ...
        var losspercent=financial(100*(loss/(initial*quantity)));
    ...
    {   //profit report
        ...
        var profitpercent=financial((profit/(initial*quantity))*100);
...
else{ showOutput("Please fill Every box with Positive Numeric values only");
